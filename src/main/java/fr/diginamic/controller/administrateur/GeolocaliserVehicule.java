...
@WebServlet(urlPatterns = "/controller/administrateur/geolocalisation/*")
public class GeolocaliserVehicule extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/WEB-INF/administrateur/positionsVoitures.jsp");
