...
public class CovoiturageDao {
	...
	public List<AnnonceCovoiturage> recupererHistoriqueAnnonces(Integer idUtilisateurCourant) {
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		List<AnnonceCovoiturage> listeDesAnnonces = new ArrayList<>();
		...
		try {
			preparedStatement = ConnectionUtils.getInstance()
					.prepareStatement("select * from covoiturage where cov_uti_id=" + idUtilisateurCourant + " and cov_datetimeDebut < now();");
			resultSet = preparedStatement.executeQuery();
			ConnectionUtils.doCommit();
			DateTimeFormatter formatterDateTime = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
			DateTimeFormatter formatterTime = DateTimeFormatter.ofPattern("HH:mm");
	...
	public List<AnnonceCovoiturage> recupererFuturesAnnonces(Integer idUtilisateurCourant) {
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		List<AnnonceCovoiturage> listeDesAnnonces = new ArrayList<>();
